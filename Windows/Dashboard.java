...
public class Dashboard extends Login{
	...
	private JPanel pCambiarContrasena,calendario;
...
//		pSidebarDashboard.setBackground(new Color(0, 153, 204));
		...
		calendario.setBorder(new LineBorder(new Color(0, 0, 0), 1, true));
		calendario.setBackground(Color.WHITE);
		calendario.setLayout(new BorderLayout());
		calendario.setSize(400, 300);
		calendario.setBounds(32, 275, 600, 337);
		resumen.add(calendario);
		
		calEjemplo1=new  JCalendar();
		calendario.add(calEjemplo1);
