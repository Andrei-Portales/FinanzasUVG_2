...
public class Login {
	...
	private void initialize() {
		...
		TextPrompt oculto = new TextPrompt("Correo electr�nico", txtUsuario);
...
//							JOptionPane.showMessageDialog(null, "¡Usuario Incorrecto!");
		...
		oculto_1 = new TextPrompt("Contrase�a (8 caracteres o m�s)", txtPassword);
		...
		oculto = new TextPrompt("Correo electr�nico", txtCorreoReg);
...
//					JOptionPane.showMessageDialog(null, "El correo que ingreso ya esta en uso");
		...
		oculto_2 = new TextPrompt("Contrase�a", txtRegistrarPassword);
